    ...
    <style>
        ...
        * {
        ...
        .overlay {
            ...
            /*background-image: url('HbEuOc (2).jpg');
...
<body>
    <div class="container" id="container">
        ...
        <div class="form-container reg-container">
            ...
            <form method="post" action="Add_Doctor" enctype="multipart/form-data">
                <h1>Doctor Registration</h1>
                <input type="text" placeholder="Name" id="doc_name_bt" name="doc_name_bt" required />
                <input type="email" placeholder="Email" id="doc_email_bt" name="doc_email_bt" required />
                <input type="password" placeholder="Password" id="doc_password_bt" name="doc_password_bt" required />
                <input type="text" placeholder="City" id="doc_city_bt" name="doc_city_bt" required />
                <input type="number" placeholder="Age" id="doc_age_bt" name="doc_age_bt" required />
                <input type="text" placeholder="Phone Number" id="doc_phone_bt" name="doc_phone_bt" required />
                <input type="text" placeholder="Specialization  =>  Format: Specialization,.." id="doc_specialization_bt" name="doc_specialization_bt" required />
                <input type="text" placeholder="Fee" id="doc_fee_bt" name="doc_fee_bt" required />
                <input style="padding-right:0;" type="file" id="img" name="img" required />
